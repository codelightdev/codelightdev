...
# 🎓 TS Academy — Full-Stack Development
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/PDO-4F5B93?style=for-the-badge&logo=php&logoColor=white" />
...
I'm increasingly interested in application security and secure software development.
...
I strongly believe that **building projects is one of the best ways to learn software development**.

Instead of only following tutorials, I try to turn what I learn into practical applications and real-world solutions.

---

## 🌦️ Weather Application

A React weather application focused on a modern glassmorphism interface and dynamic weather information.
...
- 🕐 Time-aware sunrise/sunset presentation
...
A React Todo application built to strengthen my understanding of state, props, components, and event handling.
...
I've worked on React-based shopping and e-commerce projects involving:
...
I've worked on React authentication projects involving:
...
I've explored the development of a **Computer-Based Testing platform** designed around online examinations.
...
I've worked on websites and digital solutions for different businesses and organizations.
...
# 🎵 Music & Digital Platforms

I've also explored projects involving music, entertainment, and digital content distribution.

This has introduced me to concepts around:
...
Git and GitHub are important parts of my development workflow.
...
One of the biggest lessons development has taught me is that **writing code is only part of the job**.

A developer must also know how to investigate problems.

I've worked through issues involving:
...
I don't believe I have to know everything before starting a project.

Sometimes the project itself becomes the teacher.

---

# 🎓 Education

I'm currently a **400-level student at Lagos State University (LASU)**.

My academic background is in **Mathematics**, which has helped strengthen my:
...
I'm combining my academic journey with software development as I build my career in technology.
...
| Platform | Profile |
|---|---|
| 📸 Instagram | **@codelightdev** |
| 📘 Facebook | **CodeLight** |
| ▶️ YouTube | **CodeLight Academy** |
| 🎵 TikTok | **@codelightacademy** |
| 𝕏 X / Twitter | **@codelightdev** |
| 🐙 GitHub | **@codelightdev** |
...
A project becomes valuable when people can actually use it.
...
<a href="https://github.com/codelightdev">GitHub</a> •
